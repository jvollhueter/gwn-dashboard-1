...
def main():
    ...
    if selection_mode == "Eigene Auswahl":
        ...
        default_selection = [gwk for gwk in ["DESN_EL-2-1", "DESN_NE-3"] if gwk in all_available_gwk]
    ...
    # Variablen auswählen
    show_precip = st.sidebar.checkbox("Niederschlag anzeigen", value=True)
    show_etp = st.sidebar.checkbox("ETp anzeigen", value=False)
    ...
    with tab5:
        ...
        # Daten umstrukturieren für Box Plot
        box_data = []
